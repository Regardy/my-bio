...
const discord = "https://discordapp.com/users/863591948932481054";
const discordchannel = "https://discordapp.com/users/863591948932481054";
const discordTag = "regabruhh";
const tiktok = "https://www.tiktok.com/@regabruhh";
...
export default function Home() {
  ...
  />
   ...
   <path d="M22.22 14.02v15.66c0 1.46-1.23 2.61-2.74 2.61a2.69 2.69 0 1 1 0-5.38c.15 0 .29.01.43.03v-4.73a6.67 6.67 0 0 0-.82-.05c-4.43 0-8.03 3.55-8.03 7.93 0 4.38 3.6 7.93 8.03 7.93 4.43 0 8.03-3.55 8.03-7.93V21.6c1.32 1 2.9 1.66 4.63 1.66h.82v-4.73a4.66 4.66 0 0 1-3.8-4.58h-4.67v8.68c-.06 0-.12-.01-.19-.01-2.11 0-3.82 1.69-3.82 3.77s1.71 3.77 3.82 3.77a3.8 3.8 0 0 0 3.82-3.77v-15.66h-3.77z" fill="white"/>
</svg>
                      </a>
                      <a
                        rel="noopener noreferrer nofollow"
                      ...
                      <div className="max-w-s mt-1 w-full space-y-2">
                        <div className="bg-animate group mb-1 w-full cursor-pointer rounded bg-gradient-to-r from-zinc-900 via-zinc-600 to-zinc-900 text-sm text-zinc-400 shadow transition-all">
                          <a
                            href="https://drive.google.com/drive/folders/1hftdZyZha4eQwlaHgHKrmc_VJfBbaQjI"
                            target="_self"
                            rel="noopener noreferrer nofollow"
     ...
     <div className="max-w-s mt-1 w-full space-y-2">
                    ...
                    <div className="mb-4 flex justify-center">
                      ...
                      <div className="max-w-s mt-1 w-full space-y-2">
                        <div className="bg-animate group mb-1 w-full cursor-pointer rounded bg-gradient-to-r from-zinc-900 via-zinc-600 to-zinc-900 text-sm text-zinc-400 shadow transition-all">
                          <a
                            href="https://drive.google.com/drive/folders/1BBhsz1zLCHHfD2OAydRHv-wgVvYao9Z3"
                            target="_self"
                            rel="noopener noreferrer nofollow"
                            className="w-full transition-all sm:hover:opacity-70"
                          >
                    ...
                    <div className="mb-4 flex justify-center">
                      ...
                      <div className="max-w-s mt-1 w-full space-y-2">
                        <div className="bg-animate group mb-1 w-full cursor-pointer rounded bg-gradient-to-r from-zinc-900 via-zinc-600 to-zinc-900 text-sm text-zinc-400 shadow transition-all">
                          <a
                            href="https://drive.google.com/drive/folders/1xKMgt9XfTBUEvsSsOiEwZoSq0kBMtQGV"
                            target="_self"
                            rel="noopener noreferrer nofollow"
                            className="w-full transition-all sm:hover:opacity-70"
                          >
